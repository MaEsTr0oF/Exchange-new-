...
async function fetchCurrencyRates() {
	...
	const data = await page.evaluate(() => {
		...
		sections.forEach((section) => {
			const currencyElement = section.querySelector('.table-price__name.table-price__flag');
			const currency = currencyElement ? currencyElement.textContent.trim() : 'Unknown Currency';
